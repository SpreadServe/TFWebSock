...
public class WebSocketHandler extends SimpleChannelInboundHandler<Object> {
    ...
    protected WebSocketMessageHandler       wsMessageHandler = null;
    protected NettyHttpFileHandler          httpFileHandler = new NettyHttpFileHandler( );
    protected Properties                    props = null;
    protected LinkedBlockingQueue<JSON.Message>   outQ;

   
    public WebSocketHandler(Properties props, LinkedBlockingQueue<JSON.Message> outq)
    {
        this.props = props;
        this.outQ = outq;
        wsMessageHandler = new SubscriptionHandler( outq);
    }
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        logger.warn("StockTickerServerHandler.exceptionCaught: " + cause.toString( ));
        wsMessageHandler.disconnected( ctx);
        ctx.close( );
    }
}
